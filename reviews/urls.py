...
urlpatterns = [
    ...
    url(r'^winepred/find_qual/prediction/$', views.prediction, name='prediction'),
    url(r'^winepred$', views.wine_pred, name='wine_pred'),
    url(r'^winepred/find_qual/$', views.find_qual, name='find_qual'),
    # ex: /wine/5/
